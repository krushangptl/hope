...
- **Health (❤️):** 1 ❤️ = 20 HP (max 500 HP, 25 ❤️)
...
- **Tools:** Copper Pickaxe (Learning Tool)
- **Materials:** 3x Wood (Prior Knowledge), 1x Torch (Motivation)
- **Weapons:** None
- **Armor:** None

### 🏅 Zenith Quest

_Craft 6 legendary weapons to forge The Zenith:_

- [ ] 🗡️ Terra Blade (Core CS Mastery)
- [ ] ⚔️ Meowmere (Project Portfolio)
- [ ] 🏹 Star Wrath (Interview Mastery)
- [ ] 🔪 Influx Waver (Open Source Contributions)
- [ ] ⚡ The Horseman’s Blade (DevOps Excellence)
- [ ] 🌟 Flying Dragon (Advanced Systems)

---

# 🗺️ Quest Realms

Three realms guide your 16-week journey. **NON-SKIPPABLE** tasks are critical—skipping them risks a weak foundation. DSA is prioritized early after C programming for interview readiness.

## 🌄 Realm 1: The Surface (Weeks 1-5)
...
- **Health:** 1000 HP
- **XP Reward:** +500 XP
- **Loot:** Silver Crown (Confidence +25%)

---

## ⛏️ Realm 2: The Underground (Weeks 6-10)
...
- **Health:** 2500 HP
- **XP Reward:** +1000 XP
- **Loot:** Cobalt Ore (unlocks DevOps)

---

## 🌋 Realm 3: Hardmode (Weeks 11-16)
...
- **Health:** 10,000 HP (Multi-phase)
- **XP Reward:** +2000 XP
- **Victory:** Forge The Zenith (Job Offer!)

---

# 🏆 The Zenith Forge

### Goal: Red Hat/Canonical Job Offer

Craft 6 weapons to forge The Zenith. Each adds ~16.67% progress (1 🟩).

### Weapons

1. **🗡️ Terra Blade** (Core CS Mastery)
   - Tasks: OS, DBMS, Networking
   - XP: +2000
   - Progress: +1 🟩
2. **⚔️ Meowmere** (Project Portfolio)
   - Tasks: System monitor, database engine, automation tools
   - XP: +1500
   - Progress: +1 🟩
3. **🏹 Star Wrath** (Interview Mastery)
   - Tasks: DSA, system design, problem-solving
   - XP: +1000
   - Progress: +1 🟩
4. **🔪 Influx Waver** (Open Source Contributions)
   - Tasks: Community involvement, code reviews, documentation
   - XP: +800
   - Progress: +1 🟩
5. **⚡ The Horseman’s Blade** (DevOps Excellence)
   - Tasks: Docker, Kubernetes, CI/CD
   - XP: +1200
   - Progress: +1 🟩
6. **🌟 Flying Dragon** (Advanced Systems)
   - Tasks: Network programming, optimization, scalability
   - XP: +1000
   - Progress: +1 🟩
